  ...
  return (
    <div>
     ...
     <Card>
      ...
      <hr/>
      <form onSubmit={(e)=>studentRegSubmitHandler(e,studentData,navigate,setShowModal,setModalContent)}>
      <FieldsInput label='Name' type='text' name='name' value={studentData.name} onChange={handleStudentChange}/>
      <FieldsInput label='Roll No' type='text' name='rollNo' value={studentData.rollNo} onChange={handleStudentChange}/>
      <FieldsInput label='Email' type='email' name='email' value={studentData.email} onChange={handleStudentChange}/>
      <FieldsInput label='Password' type='password' name='password' value={studentData.password} onChange={handleStudentChange}/>
      ...
      <FieldsInput label='College' type='select' name='college' value={studentData.college} onChange={handleStudentChange} options={['LIET','MITRC','NIET','Other']}/>
